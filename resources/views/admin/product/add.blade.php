    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <form method="POST" action="{{ route('admin.product.addPost') }}" class="form-horizontal">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control @error('price') is-invalid @enderror" id="price" name="price" placeholder="Enter Price" value="{{ old('price') }}" step="0.01" min="0" required>  @error('price')
                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
