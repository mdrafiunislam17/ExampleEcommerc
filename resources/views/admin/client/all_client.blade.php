        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-body table-responsive">
                    <a class="btn btn-primary" href="{{ route('admin.add.client.form') }}">Add Customer</a>
                    ...
                    <table id="table" class="table table-bordered table-striped">
                        ...
                        @foreach($clients as $client)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary btn-sm" href="{{ route('admin.edit.client',$client->id)}}">Edit</a>
                                    <a role="button" class="btn btn-danger btn-sm btnDelete" data-id="{{ $client->id }}">Delete</a>
