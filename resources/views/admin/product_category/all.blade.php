...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    <a class="btn btn-primary" href="{{ route('admin.product.category.add') }}">Add Product Category</a>
                    ...
                    <table id="table" class="table table-bordered table-striped">
                        ...
                        @foreach($categories as $category)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary btn-sm" href="{{ route('admin.product.category.edit', ['category' => $category->id]) }}">
        ...
        $(function () {
            ...
            $('#modalBtnDelete').click(function () {
                $.ajax({
                    ...
                    url: "{{ route('admin.product.category.delete') }}", // Route for deleting brand
                    data: {
                        id: selectedId,
