        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-body table-responsive">
                    <a class="btn btn-primary" href="{{ route('admin.service.add') }}">Add Business Area</a>
                    ...
                    <table id="table" class="table table-bordered table-striped">
                        ...
                        @foreach($services as $service)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('uploads/service/thumbs/'.$service->image) }}" height="50px">
                                </td>
                                <td>{{ $service->name }}</td>
                                <td>{{ $service->sort }}</td>
                                @if($service->show_home==1)
                                    <td>Yes</td>
                                @else
                                    <td>No</td>
                                @endif
                                ...
                                <td>
                                    <a class="btn btn-primary btn-sm" href="{{ route('admin.service.edit', ['service' => $service->id]) }}">Edit</a>
                                    <!--<a role="button" class="btn btn-danger btn-sm btnDelete" data-id="{{ $service->id }}">Delete</a>-->
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
