        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-body table-responsive">
                    <a class="btn btn-primary" href="{{ route('admin.job.notice.add') }}">Add Job Notice</a>
                    ...
                    <table id="table" class="table table-bordered table-striped">
                       ...
                       @foreach($notices as $notice)
                           <tr>
                               ...
                               <td>
{{--                                   <a class="btn btn-info btn-sm" href="{{ route('admin.job.apply.details', $notice->id) }}">--}}
{{--                                       <i class="fas fa-eye"></i>--}}
{{--                                   </a>--}}
                                   <a class="btn btn-primary btn-sm" href="{{ route('admin.job.notice.edit',$notice->id) }}">
                                       <i class="fas fa-edit"></i>
                                   </a>
                                   <button class="btn btn-danger btn-sm btnDelete" data-id="{{ $notice->id }}">
        ...
        $(function () {
            ...
            $('#modalBtnDelete').click(function () {
                $.ajax({
                    ...
                    url: "{{ route('admin.job.notice.delete') }}", // Route for deleting brand
                    data: {
                        id: selectedId,
